...
BOT_TOKEN = "2099434393:AAGFAkcCO1vnwW0gZh8TlnwuIuw7zfIYxqs"
PAYMENT_CHANNEL = "@techyscripter1" #add payment channel here including the '@' sign
OWNER_ID = 1284087052 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@technoscripter"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
